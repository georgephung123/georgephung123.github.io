...
![](station.png)
*An aerial view of the Charlottesville train station. Credit: Sylvia Lin*

Later in the day, we both went to Trader Joe's to pick out some flowers for my mother. Unsurprisingly, the store was *packed* near the flower section as it was Valentine's weekend. I picked out some warm colored roses with a cooler colored under-side(?) along with some filler (the small white buds you see in the image). And yes of course, I paid for it :3
![](flowers.png)
*The flowers I bought neatly placed in a vase*
...
![](ratings.png)
*The list of players registered and their respective ratings*

My only expectation going into this was to score at least one win as this was an extremely high rated tournament. The average rating was around 1780, more than two hundred points higher than what I currently have on Chess.com.

**Quick lesson on chess notation:**

Chess uses a coordinate system to describe moves. The board is an 8x8 grid 
where columns are labeled **a-h** (left to right) and rows are labeled **1-8** 
(bottom to top from White's side).
...
So **Nf3** means "Knight to f3" and **Bb5** means "Bishop to b5". 
Pawns are just the square alone, so **e4** means "pawn to e4".
...
The bishop being on a1 effectively locks it out for the rest of the game, as there is no way for your dark-squared bishop to escape after I play the move c3.
...
I resigned in this position, as my opponent had a checkmate in two. I was really bummed over this loss, as I lost extremely quickly and never had a chance. We both chatted after the game and explored some openings together!
...
In the fourth round, I faced against Spenser Kearns (1958) with the white pieces. He was actually the president of RVA Pieces!

1. e4 d5 2. exd5 Nf6 3. d4 Bg4 

![alt text](pos18.png)
This is setting up for the Portuguese Gambit if I play the natural move 4. f3. The gambit is where black doesn't recapture the pawn on d5 in order to create an extremely sharp position. It is objectively worse for black, but there are a countless number of traps white can fall into despite playing seemingly natural moves.

What's funny is that Dan and I actually went over the Portuguese Gambit, he showed me a position where I could have easily lost if I went into that gambit. Knowing that, I played the move Nf3, giving back the pawn to my opponent to avoid the sharp lines.

4. Nf3 Qxd5 5. Be2 Nc6 6. Be3 O-O-O 7. O-O e5 8. c4 Qa5 9. Bd2 Bb4 10. d5 e4 11. Ng5 Bxe2 12. Qxe2 Nd4 13. Qd1 Bxd2 14. Qxd2 Qxd2 15. Nxd2 

![alt text](pos19.png)

My g5 knight is attacking both the e4 and c7 pawns, and they both cannot be defended. My opponent defended the c7 pawn, allowing me to take the e4 pawn for free.

The computer says that he could have defended the e5 pawn with his h rook instead, the line goes 16. Nxf7 Rd7 17. Ng5 h6 18. Nh3 g5 - a rather disgusting line where you actually bait the knight into taking the seemingly free pawn just to force it into a miserable square where it's difficult for the knight to escape.

15. ... Rd7 16. Ngxe4 Nxe4 17. Nxe4 Re7 

![alt text](pos20.png)

In this position, the engine said I was "+1.3", I should played the move f3, not only it defends my knight, but it also gives me the option to move my king to f2, a critical resource.

Instead I moved my knight back to g3, it became very obvious that I made a mistake as my opponent doubled up his rooks on the e file.

18. Ng3 Rhe8 19. b4 Ne2+ 20. Nxe2 Rxe2 

![alt text](pos21.png)

After the knight trade on e2, the rook on e2 is *extremely* well placed, there are ideas of moving the rook to c2 then bring the other rook down to the second rank as well. Even though I am up a pawn, this is extremely difficult to defend, and unfortunately I also lost this game both due to the nature of the position and the time pressure mounted onto me.

I wasn't feeling too great after that loss.

Round four results:

![alt text](results4.png)
...
My opponent thought in the game that since I already moved my dark-squared bishop once, he's going to take my c5 pawn to essentially tell me that I wasted a move moving my bishop to e7.

What he had missed is that now the pawn on b2 is now undefended, and you bet I took the b2 pawn!

11. ... Qxb2 12. Nbd2 Bxc5 13. Nb3 Bb6 14. Qd3 Qf6 15. Rfd1 O-O 16. Nfd4 Rad8 17. Nxc6 bxc6 18. Rac1 Rc8 19. Nc5 Bf5 20. e4 dxe4 21. Nxe4 Bxf2+ 

![alt text](pos23.png)

A nice move found by me, winning another pawn!

My opponent cannot take the bishop with the knight, as he would lose the queen. He also cannot take it with the king, as Bxe4+ is a knock-out blow.


22. Kh1 Bxe4 23. Qxe4 Rfe8 24. Qa4 Red8 25. Rf1 Qd4

![alt text](pos24.png)

I had a pretty nice advantage until I played Qd4, that allowed my opponent to win back a pawn after a few exchanges.

It's important to know that we had opposite colored bishops, meaning that even if I'm up two whole pawns, the game could still be drawn.

I'm only up one pawn but his rook is staring at a weakness on f7.

26. Qxd4 Bxd4 27. Rxc6 Rxc6 28. Bxc6 Rd6 29. Be8 Rf6 30. Rxf6 Bxf6 31. a4 Kf8 32. Bb5 

![alt text](pos25.png)

We traded our rooks, and this position is a dead draw despite me being up a pawn.

A rather boring result after I had a great advantage against my opponent, but kudos to him defending well!
